...
function t1() {
    document.querySelector('.out-1').innerHTML = 'task-1';
}

document.querySelector('.div-1').ondblclick = t1;
...
function t3() {
    ...
    w3 = w3 + 5;
    document.querySelector('.out-3').innerHTML = 'width: ' + w3;
}
...
function t4() {
    document.querySelector('.out-4').innerHTML = 'task-4'
}
...
document.querySelector('.div-12').onmousedown = () => {
    document.querySelector('.div-12').classList = 'active';
}
...
let p = 1
function t15() {
    document.querySelector('.div-15').innerHTML = p = p + 1;
    p++;
}
...
function t18() {
    let wh1 = document.querySelector('.div-18').clientWidth
    document.querySelector('.div-18').innerHTML = wh1;
}
...
function t19() {
    let wh1 = document.querySelector('.div-18').className
    document.querySelector('.div-19').innerHTML = wh1
}
